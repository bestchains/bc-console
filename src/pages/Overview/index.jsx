...
class Overview$$Page extends React.Component {
  ...
  goProductManual() {
    window.open(
      'https://bestchains.github.io/website/docs/category/%E7%94%A8%E6%88%B7%E6%8C%87%E5%8D%97'
    );
  }
        ...
        <Row __component_name="Row" wrap={true}>
          ...
          >
            <Typography.Title
              ...
              level={1}
            >
              {this.i18n('i18n-v40k4rrg') /* undefined */}
            </Typography.Title>
          </Col>
          <Col __component_name="Col" span={24}>
            <Row __component_name="Row" style={{}} wrap={true}>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                {__$$eval(
                                  () =>
                                    this.props.useGetOverviewInfo?.data?.organizations?.filter(
                                      (item) => item.iAmIn
                                    )?.length || '0'
                                )}
                              </Typography.Text>
                          ...
                          >
                            ...
                            >
                              <Image
                                ...
                                height={64}
                                preview={false}
                                src="data:image/png;base64,"
                                width={64}
                              />
                            </Col>
                            <Col
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                {__$$eval(
                                  () =>
                                    this.props.useGetOverviewInfo?.data?.organizations
              ...
              <Col
                __component_name="Col"
                flex="375px"
                ref={this._refsManager.linkRef('col-42eb98cc')}
                style={{
                  backgroundImage:
              ...
              >
                ...
                >
                  ...
                  <Col
                    __component_name="Col"
                    ref={this._refsManager.linkRef('col-7ad672a8')}
                    span={24}
                  >
                    <Typography.Text
                      __component_name="Typography.Text"
                      __events={{
                        eventDataList: [
                          {
                            name: 'onClick',
                            relatedEventName: 'goProductManual',
                            type: 'componentEvent',
                          },
                        ],
                        eventList: [
                      ...
                      ellipsis={true}
                      onClick={function () {
                        return this.goProductManual.apply(
                          this,
                          Array.prototype.slice.call(arguments).concat([])
                        );
                      }.bind(this)}
                      ref={this._refsManager.linkRef(
                        'typography.text-3e6238ae'
                      )}
                      strong={false}
                  ...
                  <Row wrap={true}>
                    <Col span={24}>
                          ...
                          >
                            ...
                            <Col span={24}>
                              <Typography.Title
                                ...
                                level={2}
                              >
                                {this.i18n('i18n-5y78dr1c') /* undefined */}
                              </Typography.Title>
                            </Col>
                            <Col span={24}>
                              <Typography.Text
                      ...
                      <Row
                        gutter={[0, 10]}
                        h-gutter={0}
                        ref={this._refsManager.linkRef('row-c17e7e61')}
